...
// headline colour and headline weight all shift with it. Both clouds use the
// same bitmap across themes — the tint comes from the gradient behind them.
const THEMES = {
  blue:   { from: '#dff6ff', via: '#bfeeff', ink: '#88daf9', weight: 900, dot: '#3B7CD1',
            jacket: '/screen6/jacket-blue.png',   jacketH: '36.736vw' }, // 529/1440
  orange: { from: '#fff8f3', via: '#ffe3ce', ink: '#ffc190', weight: 800, dot: '#FF834E',
            jacket: '/screen6/jacket-orange.png', jacketH: '35.0vw'   }, // 504/1440
  pink:   { from: '#fff4f9', via: '#ffd6e9', ink: '#ffaed3', weight: 800, dot: '#FF54A4',
...
export default function Screen6({ onBack }) {
  ...
  return (
    <div
      ...
      style={{ '--s6-from': t.from, '--s6-via': t.via, '--s6-ink': t.ink, '--s6-weight': t.weight }}
    >
